...
Acesse as aulas pela página inicial: [`index.html`](index.html).
...
- **Fora do escopo:** autenticação de usuários e integrações com APIs externas
...
```
.
├── index.html                  # página principal (lista de aulas)
├── css/inteli-styles.css
└── module-2-common/
    ├── boas-praticas.html
    ├── js/human-type.js
    ├── planos/                 # planos de ensino (lesson-1..11)
    ├── materials/              # materiais de apoio (lesson-1..11)
    └── slides/                 # slides (slide-lesson-1..11)
```
